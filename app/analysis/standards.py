...
_HF_STANDARD_KEYS: dict[str, tuple[str | None, str | None]] = {
...
_VHF_STANDARD_KEYS: dict[str, tuple[str | None, str | None]] = {
...
_ADS_B_STANDARD_KEYS: dict[str, tuple[str | None, str | None]] = {
