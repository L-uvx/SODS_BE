...
class HfMinimumDistance5kmRule(HfRule):
    rule_code = "hf_minimum_distance_5km"
    rule_name = "hf_minimum_distance_5km"
    zone_code = "hf_minimum_distance_5km"
    minimum_distance_meters = 5000.0
