...
class HfMinimumDistance10kmRule(HfRule):
    rule_code = "hf_minimum_distance_10km"
    rule_name = "hf_minimum_distance_10km"
    zone_code = "hf_minimum_distance_10km"
    minimum_distance_meters = 10000.0
