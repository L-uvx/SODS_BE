...
class HfMinimumDistance1_3kmRule(HfRule):
    rule_code = "hf_minimum_distance_1_3km"
    rule_name = "hf_minimum_distance_1_3km"
    zone_code = "hf_minimum_distance_1_3km"
    minimum_distance_meters = 1300.0
