...
class HfMinimumDistance4kmRule(HfRule):
    rule_code = "hf_minimum_distance_4km"
    rule_name = "hf_minimum_distance_4km"
    zone_code = "hf_minimum_distance_4km"
    minimum_distance_meters = 4000.0
