...
class HfMinimumDistance15kmRule(HfRule):
    rule_code = "hf_minimum_distance_15km"
    rule_name = "hf_minimum_distance_15km"
    zone_code = "hf_minimum_distance_15km"
    minimum_distance_meters = 15000.0
