...
class HfMinimumDistance1_8kmRule(HfRule):
    rule_code = "hf_minimum_distance_1_8km"
    rule_name = "hf_minimum_distance_1_8km"
    zone_code = "hf_minimum_distance_1_8km"
    minimum_distance_meters = 1800.0
