...
from app.analysis.rules.wind_radar.common import WindRadarRule, build_wind_radar_circle_protection_zone


@dataclass(slots=True)
class BoundWindRadarElevationAngleRule(BoundObstacleRule):
    ...
    def analyze(self, obstacle: dict[str, object]) -> AnalysisRuleResult:
        ...
        return AnalysisRuleResult(
            ...
            message=(
                "obstacle within wind radar elevation angle limit"
                if is_compliant
                else "obstacle exceeds wind radar elevation angle limit"
            ),
            metrics=metrics,
...
class WindRadarElevationAngle15degRule(WindRadarRule):
    rule_code = "wind_radar_elevation_angle_15deg"
    ...
    def bind(
        ...
        *,
        station: object,
        station_point: tuple[float, float],
    ) -> BoundWindRadarElevationAngleRule | None:
        ...
        return BoundWindRadarElevationAngleRule(
            protection_zone=build_wind_radar_circle_protection_zone(
                station=station,
