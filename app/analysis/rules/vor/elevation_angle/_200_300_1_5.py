...
class Vor200_300_1_5_Rule(VorRule):
    zone_code = "vor_200_300_1_5_deg"
    zone_name = resolve_protection_zone_name(zone_code=zone_code)
    rule_code = "vor_200_300_1_5_deg"
    rule_name = "vor_200_300_1_5_deg"
    region_code = "default"
    region_name = "default"
    ...
    def bind(self, *, station, station_point):
        return bind_elevation_angle_rule(
            ...
            inner_radius_m=200.0,
            outer_radius_m=300.0,
            limit_angle_degrees=1.5,
            horizontal_angle_limit_degrees=10.0,
        )
