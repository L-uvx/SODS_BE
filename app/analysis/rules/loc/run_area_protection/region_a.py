...
class BoundLocRunAreaProtectionRegionARule(BoundObstacleRule):
    # 执行 LOC 运行保护区第 A 区判定。
...
class LocRunAreaProtectionRegionARule(ObstacleRule):
    rule_code = "loc_run_area_protection_region_a"
    rule_name = "loc_run_area_protection_region_a"
    ...
    def bind(
        ...
        *,
        ...
        region_geometry = build_loc_run_area_region_a_geometry(shared_context)
        return BoundLocRunAreaProtectionRegionARule(
