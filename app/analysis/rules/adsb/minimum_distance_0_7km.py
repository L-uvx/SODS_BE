...
class AdsbMinimumDistance0_7kmRule(AdsbRule):
    rule_code = "adsb_minimum_distance_0_7km"
    rule_name = "adsb_minimum_distance_0_7km"
    zone_code = "adsb_minimum_distance_0_7km"
    minimum_distance_meters = 700.0
