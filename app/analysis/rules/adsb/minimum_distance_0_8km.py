...
class AdsbMinimumDistance0_8kmRule(AdsbRule):
    rule_code = "adsb_minimum_distance_0_8km"
    rule_name = "adsb_minimum_distance_0_8km"
    zone_code = "adsb_minimum_distance_0_8km"
