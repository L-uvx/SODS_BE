...
class AdsbMinimumDistance1_2kmRule(AdsbRule):
    rule_code = "adsb_minimum_distance_1_2km"
    rule_name = "adsb_minimum_distance_1_2km"
    zone_code = "adsb_minimum_distance_1_2km"
    minimum_distance_meters = 1200.0
