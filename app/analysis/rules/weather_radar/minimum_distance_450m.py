...
class WeatherRadarMinimumDistance450mRule(WeatherRadarRule):
    rule_code = "weather_radar_minimum_distance_450m"
    rule_name = "weather_radar_minimum_distance_450m"
    zone_code = "weather_radar_minimum_distance_450m"
    standards_rule_code = "weather_radar_minimum_distance_450m"
    minimum_distance_meters = 450.0
