...
class VhfMinimumDistance0_3kmRule(VhfRule):
    rule_code = "vhf_minimum_distance_0_3km"
    rule_name = "vhf_minimum_distance_0_3km"
    zone_code = "vhf_minimum_distance_0_3km"
    minimum_distance_meters = 300.0
