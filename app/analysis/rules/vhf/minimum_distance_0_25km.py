...
class VhfMinimumDistance0_25kmRule(VhfRule):
    rule_code = "vhf_minimum_distance_0_25km"
    rule_name = "vhf_minimum_distance_0_25km"
    zone_code = "vhf_minimum_distance_0_25km"
    minimum_distance_meters = 250.0
